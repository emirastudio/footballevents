        ...
        <EventWizard
          ...
          defaults={{
            ...
            divisions: ev.divisions.map((d) => ({
              ...
              startDate: d.startDate ? d.startDate.toISOString().slice(0, 10) : undefined,
              endDate:   d.endDate   ? d.endDate.toISOString().slice(0, 10)   : undefined,
              priceFrom: d.priceFrom != null ? Number(d.priceFrom) : undefined,
